...
def draw_frame(image, face_landmarks, mp_drawing, mp_drawing_styles, mp_face_mesh, current_keys):
    ...
    cv2.putText(frame, current_keys, (620, 30),    # writes stringonto fram at specified position
